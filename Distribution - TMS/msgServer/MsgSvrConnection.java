...
public class MsgSvrConnection extends Thread 
{
  ...
  private Connection jdbc;///// 1.0.0.0) MsgSvrConnection /////

  /**
   * Construct a new object of type MsgSvrConnection
   */
  public MsgSvrConnection(Socket socket, MessageServer server, Connection jdbc)///// 1.0.0.1) MsgSvrConnection /////
  {
  ...
  public void run()
  {
	...
	// get the appropriate Command class from the CommandFactory
        command = CommandFactory.getCommand(reader, writer, this, jdbc);///// 1.0.0.2) MsgSvrConnection /////
